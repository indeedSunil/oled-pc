...
void loop() {
  ...
  // } //this code is currently commented due to memory problem..on uncommenting this code stopwatch stops to function
  //so i had to uncomment this
...
void phoneDraw() {
  ...
  display.print("9847620186");


  display.setCursor(0, 28);
  display.print("Email");
  display.setCursor(0, 38);
  display.print("sunillc3@gmail.com");
  display.drawLine(0, 25, 63, 25, 1);

  display.setCursor(0, 52);
  display.print("byteWiz");
  display.setCursor(0, 62);
  display.print("9745988743");


  display.setCursor(0, 76);
  display.print("Email");
  display.setCursor(0, 86);
  display.print("byte@wiz.com");
